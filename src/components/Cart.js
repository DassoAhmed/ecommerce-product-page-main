...
export default function Cart(){
   const text = "Autumn Limited Edition Sneakers"; 
    ...
    absolute right-8 top-32 left-8 lg:w-96 lg:left-auto lg:top-20 "
     style={{
        zIndex: 1000,
    }}>
    ...
    <div className="flex items-center justify-between">
        ...
        <li className="text-slate-600 text-sm">{`${text.substring(
            ...
            <span className="font-bold
             text-slate-900 ">$375.000</span></li>
        </ul>
...
<button className=" bg-orange-500 py-2 px-4 text-white font-bold 
           rounded-lg shadow mt-5 w-full  hover:bg-orange-600
           transition-all duration-200 ">Checkout </button>
    </article>
    </>
}